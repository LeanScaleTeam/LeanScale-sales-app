...
:::info[📹 Teaching Script]
*"In this training, we're going to be talking about one of the most foundational projects in all of GTM. It's the project that takes your ICP and Personas and actually operationalizes them. Let me show you what that actually looks like..."*

*[Show Market Map dashboard - first "wow" moment]*
:::

### What is Market Map?

:::tip[📹 Key Point]
*"This is what it looks like when your ICP isn't just a document sitting in a folder... It's infrastructure — loaded into your CRM, powering your dashboards, telling your team where to focus."*
:::
