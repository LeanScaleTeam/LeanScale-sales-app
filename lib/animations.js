...
// Presenter slide transition (enter from right)
export const presenterSlideRight = {
  hidden: { x: 100, opacity: 0 },
  show: { x: 0, opacity: 1, transition: { duration: 0.4, ease: 'easeInOut' } },
  exit: { x: -100, opacity: 0, transition: { duration: 0.3, ease: 'easeInOut' } },
};

// Presenter slide transition (enter from left — for going back)
export const presenterSlideLeft = {
  hidden: { x: -100, opacity: 0 },
  show: { x: 0, opacity: 1, transition: { duration: 0.4, ease: 'easeInOut' } },
  exit: { x: 100, opacity: 0, transition: { duration: 0.3, ease: 'easeInOut' } },
};
