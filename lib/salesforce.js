 ...
 */
export function getAuthorizationUrl(customerId, slug, isSandbox = false, codeChallenge) {
 ...
 */
export async function exchangeCodeForTokens(code, isSandbox = false, codeVerifier = undefined) {
  const baseUrl = isSandbox ? SF_SANDBOX_LOGIN_URL : SF_LOGIN_URL;
